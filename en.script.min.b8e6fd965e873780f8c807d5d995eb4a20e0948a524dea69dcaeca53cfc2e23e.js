$(function(){var baseURL="https://webninjasi.github.io/tfmrecords/";var maps={"0":1,"1":1,"123456":1,};$('.date-convert').each(function(){$(this).text(moment.unix($(this).text()).format("LL"));});$("#book-search-input").keypress(function(e){if(e.keyCode!=13){return true;}
